...
bool Particle::Draw()
{
	...
	ret = app->render->DrawParticle(app->particleSystem->GetParticleAtlas(), (int)center.x, (int)center.y, &pRect, &rectSize, resColor, 0.2, blendMode, 1.0f, curRotSpeed);
	...
	/*if (app->render->debug)
	{
		...
		debugColor.a = 100;
		app->render->DrawRectangle({(int)pos.x - rectSize.w/2,(int)pos.y - rectSize.h/2,rectSize.w,rectSize.h}, debugColor.r, debugColor.g, debugColor.b, debugColor.a);
	}*/
